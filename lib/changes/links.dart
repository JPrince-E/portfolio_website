// CV
const String resume =
    'https://drive.google.com/file/d/1s4XLTiuIT570DLZxPXck_DuiELufq7sH/view?usp=sharing';

// Github Link
const String gitHub = 'https://github.com/JPrince-E';
// Github Link
const String mail = 'adebayoadedayoea@gmail.com';
// Github Link
const String facebook = 'https://www.facebook.com/enochadebayo.adedayo';
// Github Link
const String twitter = 'https://twitter.com/PrinceE82968504';
// Github Link
const String youtube =
    'https://www.youtube.com/channel/UCXooUY2oL_eqGhTaZn-ExSg';
// Github Link
const String linkedin = 'https://www.linkedin.com/in/enoch-adegunloye-7923811b2/';
// Github Link
const String buymeacoffee = 'https://www.buymeacoffee.com/sudeshnb';
// Github Link
const String instagram = 'https://www.instagram.com/princee1138/';
// socialLinks
...
// Github Link
const String whatsapp = 'https://api.whatsapp.com/send?phone=2348169020314';
